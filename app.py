...
def create_frequency_table(data, period=None, start_period=None, end_period=None, max_upper=10):
    ...
    # Ensure consistent zero display
            ...
            if table is not None:
                ...
                st.dataframe(
                    ...
                    column_config={
                        ...
                        "#Students": st.column_config.NumberColumn("#Students", width=90),
                        "Cum 1->": st.column_config.NumberColumn("Cum 1->", width=80),
                        "Cum ->End": st.column_config.NumberColumn("Cum ->End", width=90),
